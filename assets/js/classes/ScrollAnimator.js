    ...
    onIntersection(entries) {
        ...
        entries.forEach(
            function (objetVisible) {
                ...
                console.log(element, intersecte);

                if (intersecte == true) {
                    element.animate([{ opacity: 0 }, { opacity: 1 }], { fill: "forwards", duration: 2000 });
                } else {
                    element.animate([{ opacity: 1 }, { opacity: 0 }], { fill: "forwards", duration: 2000 });
                }
